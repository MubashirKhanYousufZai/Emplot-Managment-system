...
// Variable of employ
let employ = [
  "First employ: (Name: Ali , Age: 19 , Post: Sales Manager , Salary: 190000)",
...
let removeEmploy = async () => {
  ...
  console.log(
    `Your employ is removed ${employIndex_number.number} [view list of employs (list_employs)]`
  );
};
...
let update_Employ = async () => {
  ...
  console.log(
    `Updates at index number number ${updateEmploy.Update} updated Succesfully. [For checking updates view list_employs]`
  );
};
